...
/*
Exercise 3. Rather than returning the first error found,
return back a single error that contains all errors discovered during validation.
Update the code in +main()+ to properly handle multiple errors.
*/
...
/*
processError is a method for converting an error into a message.
It has special handling for ErrInvalidID and EmptyFieldError.
*/
